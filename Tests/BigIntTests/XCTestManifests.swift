...
extension ApplyA_ApplyB_Equals_ApplyAB {
    ...
    static let __allTests__ApplyA_ApplyB_Equals_ApplyAB = [
        ("test_add_heap", test_add_heap),
        ("test_add_smi", test_add_smi),
        ("test_div_heap", test_div_heap),
        ("test_div_smi", test_div_smi),
        ("test_mul_heap", test_mul_heap),
        ("test_mul_smi", test_mul_smi),
        ("test_shiftLeft_heap", test_shiftLeft_heap),
        ("test_shiftLeft_smi", test_shiftLeft_smi),
        ("test_shiftRight_heap", test_shiftRight_heap),
        ("test_shiftRight_smi", test_shiftRight_smi),
        ("test_sub_heap", test_sub_heap),
        ("test_sub_smi", test_sub_smi),
    ]
}
