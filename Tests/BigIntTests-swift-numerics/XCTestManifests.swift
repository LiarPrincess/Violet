...
extension BigIntStorageTests {
    ...
    static let __allTests__BigIntStorageTests = [
        ...
        ("test_fixInvariants_suffix0", test_fixInvariants_suffix0),
        ("test_fixInvariants_zero", test_fixInvariants_zero),
        ...
        ("test_replaceAll_moreThanCount", test_replaceAll_moreThanCount),
        ("test_replaceAll_moreThanCount_cow", test_replaceAll_moreThanCount_cow),
        ("test_replaceAll_zero", test_replaceAll_zero),
        ("test_set_Int", test_set_Int),
        ("test_set_Int_cow", test_set_Int_cow),
        ("test_set_UInt", test_set_UInt),
        ("test_set_UInt_cow", test_set_UInt_cow),
        ("test_withMutableWordsBuffer", test_withMutableWordsBuffer),
        ("test_withMutableWordsBuffer_cow", test_withMutableWordsBuffer_cow),
        ("test_withWordsBuffer", test_withWordsBuffer),
    ]
}
...
extension InitFromBinaryFloatingPoint754Tests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__InitFromBinaryFloatingPoint754Tests = [
        ("test_infinity", test_infinity),
        ("test_integerSpacing_by1", test_integerSpacing_by1),
        ("test_integerSpacing_by2", test_integerSpacing_by2),
        ("test_integerSpacing_by4", test_integerSpacing_by4),
        ("test_integerSpacing_by¹౹₂", test_integerSpacing_by¹౹₂),
        ("test_integerSpacing_by¹౹₄", test_integerSpacing_by¹౹₄),
        ("test_integerSpacing_galaxyFarFarAway", test_integerSpacing_galaxyFarFarAway),
        ("test_nanana_Batman", test_nanana_Batman),
        ("test_predefinedCases", test_predefinedCases),
        ("test_subnormal", test_subnormal),
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(InitFromBinaryFloatingPoint754Tests.__allTests__InitFromBinaryFloatingPoint754Tests),
