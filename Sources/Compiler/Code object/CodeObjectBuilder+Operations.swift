...
extension CodeObjectBuilder {
  ...
  /// Append a `compareOp` instruction to currently filled code object.
  public func emitCompareOp(value: ComparisonOpcode, location: SourceLocation) throws {
    // try self.emit(.compareOp, location: location)
