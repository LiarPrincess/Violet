...
extension CodeObject {
  ...
  public func emitStoreName<S: ConstantString>(name: S,
  ...
  public func emitLoadName<S: ConstantString>(name: S,
                                              location: SourceLocation) throws {
    let index = try self.addNameWithExtendedArgIfNeeded(name: name, location: location)
  ...
  public func emitDeleteName<S: ConstantString>(name: S,
                                                location: SourceLocation) throws {
    let index = try self.addNameWithExtendedArgIfNeeded(name: name, location: location)
  ...
  public func emitStoreAttribute<S: ConstantString>(name: S,
                                                    location: SourceLocation) throws {
    let index = try self.addNameWithExtendedArgIfNeeded(name: name, location: location)
  ...
  public func emitLoadAttribute<S: ConstantString>(name: S,
                                                   location: SourceLocation) throws {
    let index = try self.addNameWithExtendedArgIfNeeded(name: name, location: location)
  ...
  public func emitDeleteAttribute<S: ConstantString>(name: S,
                                                     location: SourceLocation) throws {
    let index = try self.addNameWithExtendedArgIfNeeded(name: name, location: location)
  ...
  public func emitStoreGlobal<S: ConstantString>(name: S,
                                                 location: SourceLocation) throws {
    let index = try self.addNameWithExtendedArgIfNeeded(name: name, location: location)
  ...
  public func emitLoadGlobal<S: ConstantString>(name: S,
                                                location: SourceLocation) throws {
    let index = try self.addNameWithExtendedArgIfNeeded(name: name, location: location)
  ...
  public func emitDeleteGlobal<S: ConstantString>(name: S,
                                                  location: SourceLocation) throws {
    let index = try self.addNameWithExtendedArgIfNeeded(name: name, location: location)
  ...
  public func emitLoadFast<S: ConstantString>(name: S,
                                              location: SourceLocation) throws {
  ...
  public func emitStoreFast<S: ConstantString>(name: S,
                                               location: SourceLocation) throws {
  ...
  public func emitDeleteFast<S: ConstantString>(name: S,
                                                location: SourceLocation) throws {
  ...
  public func emitLoadDeref<S: ConstantString>(name: S,
                                               location: SourceLocation) throws {
  ...
  public func emitLoadClassDeref<S: ConstantString>(name: S,
                                                    location: SourceLocation) throws {
  ...
  public func emitStoreDeref<S: ConstantString>(name: S,
                                                location: SourceLocation) throws {
  ...
  public func emitDeleteDeref<S: ConstantString>(name: S,
                                                 location: SourceLocation) throws {
