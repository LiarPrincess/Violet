...
|loadClassCell(cellIndex: CellIndex)|Much like `LoadCellOrFree` but first checks the locals dictionary before consulting the `cell`.<br/>This is used for loading free variables in `class` bodies.|
