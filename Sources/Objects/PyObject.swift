...
public struct PyObject: PyObjectMixin {
  ...
  internal static func hash(_ py: Py, zelf: PyObject) -> PyHash {
  ...
  internal static func str(_ py: Py, zelf: PyObject) -> PyResult<String> {
  ...
  internal static func dir(_ py: Py, zelf: PyObject) -> PyResult<PyObject> {
    var dir = DirResult()
  ...
  internal static func subclasshook(_ py: Py,
                                    args: [PyObject],
