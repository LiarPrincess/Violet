extension AbstractString {
  ...
  internal static func abstractIsAlphaNumeric(_ py: Py, zelf: PyObject) -> PyResultGen<PyObject> {
  ...
  /// and there is at least one character.
  internal static func abstractIsAlpha(_ py: Py, zelf: PyObject) -> PyResultGen<PyObject> {
    guard let zelf = Self.downcast(py, zelf) else {
  ...
  internal static func abstractIsAscii(_ py: Py, zelf: PyObject) -> PyResultGen<PyObject> {
    guard let zelf = Self.downcast(py, zelf) else {
  ...
  /// and there is at least one character.
  internal static func abstractIsDigit(_ py: Py, zelf: PyObject) -> PyResultGen<PyObject> {
    guard let zelf = Self.downcast(py, zelf) else {
  ...
  internal static func abstractIsLower(_ py: Py, zelf: PyObject) -> PyResultGen<PyObject> {
    guard let zelf = Self.downcast(py, zelf) else {
  ...
  /// and there is at least one cased character.
  internal static func abstractIsUpper(_ py: Py, zelf: PyObject) -> PyResultGen<PyObject> {
    guard let zelf = Self.downcast(py, zelf) else {
  ...
  /// and there is at least one character.
  internal static func abstractIsSpace(_ py: Py, zelf: PyObject) -> PyResultGen<PyObject> {
    guard let zelf = Self.downcast(py, zelf) else {
  ...
  internal static func abstractIsTitle(_ py: Py, zelf: PyObject) -> PyResultGen<PyObject> {
    guard let zelf = Self.downcast(py, zelf) else {
