...
extension PyType {
  ...
  internal static func str(_ context: PyContext, type: PyType, base: PyType) -> PyType {
    ...
    result._attributes["title"] = PyType.wrapMethod(context, name: "title", doc: nil, func: PyString.title, castSelf: PyType.selfAsPyString)
    result._attributes["swapcase"] = PyType.wrapMethod(context, name: "swapcase", doc: nil, func: PyString.swapcase, castSelf: PyType.selfAsPyString)
    result._attributes["casefold"] = PyType.wrapMethod(context, name: "casefold", doc: nil, func: PyString.casefold, castSelf: PyType.selfAsPyString)
    result._attributes["capitalize"] = PyType.wrapMethod(context, name: "capitalize", doc: nil, func: PyString.capitalize, castSelf: PyType.selfAsPyString)
    result._attributes["center"] = PyType.wrapMethod(context, name: "center", doc: nil, func: PyString.center(width:fillChar:), castSelf: PyType.selfAsPyString)
    result._attributes["ljust"] = PyType.wrapMethod(context, name: "ljust", doc: nil, func: PyString.ljust(width:fillChar:), castSelf: PyType.selfAsPyString)
    result._attributes["rjust"] = PyType.wrapMethod(context, name: "rjust", doc: nil, func: PyString.rjust(width:fillChar:), castSelf: PyType.selfAsPyString)
    result._attributes["split"] = PyType.wrapMethod(context, name: "split", doc: nil, func: PyString.split(separator:maxCount:), castSelf: PyType.selfAsPyString)
    result._attributes["rsplit"] = PyType.wrapMethod(context, name: "rsplit", doc: nil, func: PyString.rsplit(separator:maxCount:), castSelf: PyType.selfAsPyString)
    result._attributes["splitlines"] = PyType.wrapMethod(context, name: "splitlines", doc: nil, func: PyString.splitLines(keepEnds:), castSelf: PyType.selfAsPyString)
    result._attributes["partition"] = PyType.wrapMethod(context, name: "partition", doc: nil, func: PyString.partition(separator:), castSelf: PyType.selfAsPyString)
    result._attributes["rpartition"] = PyType.wrapMethod(context, name: "rpartition", doc: nil, func: PyString.rpartition(separator:), castSelf: PyType.selfAsPyString)
    result._attributes["expandtabs"] = PyType.wrapMethod(context, name: "expandtabs", doc: nil, func: PyString.expandTabs(tabSize:), castSelf: PyType.selfAsPyString)
    result._attributes["count"] = PyType.wrapMethod(context, name: "count", doc: nil, func: PyString.count(_:start:end:), castSelf: PyType.selfAsPyString)
    result._attributes["replace"] = PyType.wrapMethod(context, name: "replace", doc: nil, func: PyString.replace(old:new:count:), castSelf: PyType.selfAsPyString)
    result._attributes["zfill"] = PyType.wrapMethod(context, name: "zfill", doc: nil, func: PyString.zfill(width:), castSelf: PyType.selfAsPyString)
