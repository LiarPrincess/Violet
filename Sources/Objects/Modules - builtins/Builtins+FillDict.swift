...
//    self.setOrTrap(.weakref, type: self.py.types.weakref)
    ...
    // MARK: - Functions
    self.setOrTrap(.__build_class__, doc: Self.__build_class__Doc, fn: Self.__build_class__(_:module:args:kwargs:))
    self.setOrTrap(.__import__, doc: Self.__import__Doc, fn: Self.__import__(_:module:args:kwargs:))
    self.setOrTrap(.abs, doc: Self.absDoc, fn: Self.abs(_:module:object:))
    self.setOrTrap(.all, doc: Self.allDoc, fn: Self.all(_:module:iterable:))
    self.setOrTrap(.any, doc: Self.anyDoc, fn: Self.any(_:module:iterable:))
    self.setOrTrap(.ascii, doc: Self.asciiDoc, fn: Self.ascii(_:module:object:))
    self.setOrTrap(.bin, doc: Self.binDoc, fn: Self.bin(_:module:object:))
//    self.setOrTrap(.breakpoint, doc: Self.breakpointDoc, fn: Self.breakpoint)
    self.setOrTrap(.callable, doc: Self.callableDoc, fn: Self.callable(_:module:object:))
    self.setOrTrap(.chr, doc: Self.chrDoc, fn: Self.chr(_:module:object:))
    self.setOrTrap(.compile, doc: Self.compileDoc, fn: Self.compile(_:module:args:kwargs:))
    self.setOrTrap(.delattr, doc: Self.delattrDoc, fn: Self.delattr(_:module:object:name:))
    self.setOrTrap(.dir, doc: Self.dirDoc, fn: Self.dir(_:module:object:))
    self.setOrTrap(.divmod, doc: Self.divmodDoc, fn: Self.divmod(_:module:left:right:))
    self.setOrTrap(.eval, doc: Self.evalDoc, fn: Self.eval(_:module:args:kwargs:))
    self.setOrTrap(.exec, doc: Self.execDoc, fn: Self.exec(_:module:args:kwargs:))
//    self.setOrTrap(.format, doc: Self.formatDoc, fn: Self.format(value:format:))
    self.setOrTrap(.getattr, doc: Self.getattrDoc, fn: Self.getattr(_:module:object:name:default:))
    self.setOrTrap(.globals, doc: Self.globalsDoc, fn: Self.globals(_:module:))
    self.setOrTrap(.hasattr, doc: Self.hasattrDoc, fn: Self.hasattr(_:module:object:name:))
    self.setOrTrap(.hash, doc: Self.hashDoc, fn: Self.hash(_:module:object:))
//    self.setOrTrap(.help, doc: Self.helpDoc, fn: Self.help)
    self.setOrTrap(.hex, doc: Self.hexDoc, fn: Self.hex(_:module:object:))
    self.setOrTrap(.id, doc: Self.idDoc, fn: Self.id(_:module:object:))
//    self.setOrTrap(.input, doc: Self.inputDoc, fn: Self.input)
    self.setOrTrap(.isinstance, doc: Self.isinstanceDoc, fn: Self.isinstance(_:module:object:of:))
    self.setOrTrap(.issubclass, doc: Self.issubclassDoc, fn: Self.issubclass(_:module:object:of:))
    self.setOrTrap(.iter, doc: Self.iterDoc, fn: Self.iter(_:module:object:sentinel:))
    self.setOrTrap(.len, doc: Self.lenDoc, fn: Self.len(_:module:iterable:))
    self.setOrTrap(.locals, doc: Self.localsDoc, fn: Self.locals(_:module:))
    self.setOrTrap(.max, doc: Self.maxDoc, fn: Self.max(_:module:args:kwargs:))
    self.setOrTrap(.min, doc: Self.minDoc, fn: Self.min(_:module:args:kwargs:))
    self.setOrTrap(.next, doc: Self.nextDoc, fn: Self.next(_:module:iterator:default:))
    self.setOrTrap(.oct, doc: Self.octDoc, fn: Self.oct(_:module:object:))
    self.setOrTrap(.open, doc: Self.openDoc, fn: Self.open(_:module:args:kwargs:))
    self.setOrTrap(.ord, doc: Self.ordDoc, fn: Self.ord(_:module:object:))
    self.setOrTrap(.pow, doc: Self.powDoc, fn: Self.pow(_:module:base:exp:mod:))
    self.setOrTrap(.print, doc: Self.printDoc, fn: Self.print(_:module:args:kwargs:))
    self.setOrTrap(.repr, doc: Self.reprDoc, fn: Self.repr(_:module:object:))
    self.setOrTrap(.round, doc: Self.roundDoc, fn: Self.round(_:module:number:nDigits:))
    self.setOrTrap(.setattr, doc: Self.setattrDoc, fn: Self.setattr(_:module:object:name:value:))
    self.setOrTrap(.sorted, doc: Self.sortedDoc, fn: Self.sorted(_:module:args:kwargs:))
    self.setOrTrap(.sum, doc: Self.sumDoc, fn: Self.sum(_:module:args:kwargs:))
