...
extension Sys {
  ...
  internal var abiFlags: PyObject {
    self.unimplemented(name: "abiflags")
  }
  ...
  internal var baseExecPrefix: PyObject {
    self.unimplemented(name: "base_exec_prefix")
  }
  ...
  internal var basePrefix: PyObject {
    self.unimplemented(name: "base_prefix")
  }
  ...
  internal var byteOrder: PyObject {
    self.unimplemented(name: "byteorder")
  }
  ...
  internal func callTracing() -> PyObject {
    self.unimplemented(name: "call_tracing")
  }
  ...
  internal func _clearTypeCache() -> PyObject {
    self.unimplemented(name: "_clear_type_cache")
  }
  ...
  internal func _currentFrames() -> PyObject {
    self.unimplemented(name: "_current_frames")
  }
  ...
  internal func breakpointHook() -> PyObject {
    self.unimplemented(name: "breakpointhook")
  }
  ...
  internal func _debugMallocStats() -> PyObject {
    self.unimplemented(name: "_debugmallocstats")
  }
  ...
  internal var dllHandle: PyObject {
    self.unimplemented(name: "dllhandle")
  }
  ...
  internal func displayHook() -> PyObject {
    self.unimplemented(name: "displayhook")
  }
  ...
  internal var dontWriteBytecode: PyObject {
    self.unimplemented(name: "dont_write_bytecode")
  }
  ...
  internal func exceptHook() -> PyObject {
    self.unimplemented(name: "excepthook")
  }
  ...
  internal var __breakpointHook__: PyObject {
    self.unimplemented(name: "__breakpointhook__")
  }
  ...
  internal func exceptionInfo() -> PyObject {
    self.unimplemented(name: "exc_info")
  }
  ...
  internal var floatInfo: PyObject {
    self.unimplemented(name: "float_info")
  }
  ...
  internal var floatReprStyle: PyObject {
    self.unimplemented(name: "float_repr_style")
  }
  ...
  internal func getAllocatedBlocks() -> PyObject {
    self.unimplemented(name: "getallocatedblocks")
  }
  ...
  internal func getAndroidApiLevel() -> PyObject {
    self.unimplemented(name: "getandroidapilevel")
  }
  ...
  internal func getDlopenFlags() -> PyObject {
    self.unimplemented(name: "getdlopenflags")
  }
  ...
  internal func getFileSystemEncoding() -> PyObject {
    self.unimplemented(name: "getfilesystemencoding")
  }
  ...
  internal func getFileSystemEncodeErrors() -> PyObject {
    self.unimplemented(name: "getfilesystemencodeerrors")
  }
  ...
  internal func getRefCount() -> PyObject {
    self.unimplemented(name: "getrefcount")
  }
  ...
  internal func getRecursionLimit() -> PyObject {
    self.unimplemented(name: "getrecursionlimit")
  }
  ...
  internal func getSizeof() -> PyObject {
    self.unimplemented(name: "getsizeof")
  }
  ...
  internal func getSwitchInterval() -> PyObject {
    self.unimplemented(name: "getswitchinterval")
  }
  ...
  internal func _getFrame() -> PyObject {
    self.unimplemented(name: "_getframe")
  }
  ...
  internal func getProfile() -> PyObject {
    self.unimplemented(name: "getprofile")
  }
  ...
  internal func getTrace() -> PyObject {
    self.unimplemented(name: "gettrace")
  }
  ...
  internal func getWindowsVersion() -> PyObject {
    self.unimplemented(name: "getwindowsversion")
  }
  ...
  internal func getAsyncGenHooks() -> PyObject {
    self.unimplemented(name: "get_asyncgen_hooks")
  }
  ...
  internal func getCoroutineOriginTrackingDepth() -> PyObject {
    self.unimplemented(name: "get_coroutine_origin_tracking_depth")
  }
  ...
  internal var intInfo: PyObject {
    self.unimplemented(name: "int_info")
  }
  ...
  internal func isFinalizing() -> PyObject {
    self.unimplemented(name: "is_finalizing")
  }
  ...
  internal var lastType: PyObject {
    self.unimplemented(name: "last_type")
  }
  ...
  internal var maxSize: PyObject {
    self.unimplemented(name: "maxsize")
  }
  ...
  internal var maxUnicode: PyObject {
    self.unimplemented(name: "maxunicode")
  }
  ...
  internal func setCheckInterval() -> PyObject {
    self.unimplemented(name: "setcheckinterval")
  }
  ...
  internal func setDlopenFlags() -> PyObject {
    self.unimplemented(name: "setdlopenflags")
  }
  ...
  internal func setProfile() -> PyObject {
    self.unimplemented(name: "setprofile")
  }
  ...
  internal func setRecursionLimit() -> PyObject {
    self.unimplemented(name: "setrecursionlimit")
  }
  ...
  internal func setSwitchInterval() -> PyObject {
    self.unimplemented(name: "setswitchinterval")
  }
  ...
  internal func setTrace() -> PyObject {
    self.unimplemented(name: "settrace")
  }
  ...
  internal func setAsyncGenHooks() -> PyObject {
    self.unimplemented(name: "set_asyncgen_hooks")
  }
  ...
  internal func setCoroutineOriginTrackingDepth() -> PyObject {
    self.unimplemented(name: "set_coroutine_origin_tracking_depth")
  }
  ...
  internal func setCoroutineWrapper() -> PyObject {
    self.unimplemented(name: "set_coroutine_wrapper")
  }
  ...
  internal func _enableLegacyWindowsFSEncoding() -> PyObject {
    self.unimplemented(name: "_enablelegacywindowsfsencoding")
  }
  ...
  internal var threadInfo: PyObject {
    self.unimplemented(name: "thread_info")
  }
  ...
  internal var tracebackLimit: PyObject {
    self.unimplemented(name: "tracebacklimit")
  }
  ...
  internal var apiVersion: PyObject {
    self.unimplemented(name: "api_version")
  }
  ...
  internal var winver: PyObject {
    self.unimplemented(name: "winver")
  }
  ...
  internal var _xoptions: PyObject {
    self.unimplemented(name: "_xoptions")
  }

  // MARK: - Unimplemented

  private func unimplemented(name: String) -> Never {
    trap("'sys.\(name)' is not implemented")
  }
}
