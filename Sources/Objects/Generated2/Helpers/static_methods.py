...
_stringConversion = StaticMethodKind('StringConversion', '(context: PyContext, object: PyObject) -> PyResult<String>')
_hash = StaticMethodKind('Hash', '(context: PyContext, object: PyObject) -> HashResult')
_dir = StaticMethodKind('Dir', '(context: PyContext, object: PyObject) -> PyResult<DirResult>')
_comparison = StaticMethodKind('Comparison', '(context: PyContext, left: PyObject, right: PyObject) -> CompareResult')
_asBool = StaticMethodKind('AsBool', '(context: PyContext, object: PyObject) -> Bool')
_asInt = StaticMethodKind('AsInt', '(context: PyContext, object: PyObject) -> PyResult<PyInt>')
_asFloat = StaticMethodKind('AsFloat', '(context: PyContext, object: PyObject) -> PyResult<PyFloat>')
_asComplex = StaticMethodKind('AsComplex', '(context: PyContext, object: PyObject) -> PyObject')
_asIndex = StaticMethodKind('AsIndex', '(context: PyContext, object: PyObject) -> BigInt')
_getAttribute = StaticMethodKind('GetAttribute', '(context: PyContext, object: PyObject, name: PyObject) -> PyResult<PyObject>')
_setAttribute = StaticMethodKind('SetAttribute', '(context: PyContext, object: PyObject, name: PyObject, value: PyObject?) -> PyResult<PyNone>')
_delAttribute = StaticMethodKind('DelAttribute', '(context: PyContext, object: PyObject, name: PyObject) -> PyResult<PyNone>')
_getItem = StaticMethodKind('GetItem', '(context: PyContext, object: PyObject, index: PyObject) -> PyResult<PyObject>')
_setItem = StaticMethodKind('SetItem', '(context: PyContext, object: PyObject, index: PyObject, value: PyObject) -> PyResult<PyNone>')
_delItem = StaticMethodKind('DelItem', '(context: PyContext, object: PyObject, index: PyObject) -> PyResult<PyNone>')
_iter = StaticMethodKind('Iter', '(context: PyContext, object: PyObject) -> PyObject')
_next = StaticMethodKind('Next', '(context: PyContext, object: PyObject) -> PyResult<PyObject>')
_getLength = StaticMethodKind('GetLength', '(context: PyContext, object: PyObject) -> BigInt')
_contains = StaticMethodKind('Contains', '(context: PyContext, object: PyObject, element: PyObject) -> PyResult<Bool>')
_reversed = StaticMethodKind('Reversed', '(context: PyContext, object: PyObject) -> PyObject')
_keys = StaticMethodKind('Keys', '(context: PyContext, object: PyObject) -> PyObject')
_del = StaticMethodKind('Del', '(context: PyContext, object: PyObject) -> PyResult<PyNone>')
_call = StaticMethodKind('Call', '(context: PyContext, object: PyObject, args: [PyObject], kwargs: PyDict?) -> PyResult<PyObject>')
_instanceCheck = StaticMethodKind('InstanceCheck', '(context: PyContext, type: PyObject, object: PyObject) -> Bool')
_subclassCheck = StaticMethodKind('SubclassCheck', '(context: PyContext, type: PyObject, base: PyObject) -> PyResult<Bool>')
_isAbstractMethod = StaticMethodKind('IsAbstractMethod', '(context: PyContext, object: PyObject) -> PyResult<Bool>')
_numericUnary = StaticMethodKind('NumericUnary', '(context: PyContext, object: PyObject) -> PyObject')
_numericTrunc = StaticMethodKind('NumericTrunc', '(context: PyContext, object: PyObject) -> PyResult<PyInt>')
_numericRound = StaticMethodKind('NumericRound', '(context: PyContext, object: PyObject, nDigits: PyObject?) -> PyResult<PyObject>')
_numericBinary = StaticMethodKind('NumericBinary', '(context: PyContext, left: PyObject, right: PyObject) -> PyResult<PyObject>')
_numericPow = StaticMethodKind('NumericPow', '(context: PyContext, base: PyObject, exp: PyObject, mod: PyObject) -> PyResult<PyObject>')
