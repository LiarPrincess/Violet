...
protocol __cause__Owner { func getCause() -> PyObject }
protocol __class__Owner { func getClass() -> PyType }
protocol __code__Owner { func getCode() -> PyCode }
protocol __contains__Owner { func contains(_ element: PyObject) -> PyResult<Bool> }
protocol __context__Owner { func getContext() -> PyObject }
...
protocol __module__Owner { func getModule() -> String }
protocol __mul__Owner { func mul(_ other: PyObject) -> PyResultOrNot<PyObject> }
protocol __name__Owner { func getName() -> String }
...
protocol __qualname__Owner { func getQualname() -> String }
...
protocol __suppress_context__Owner { func getSuppressContext() -> PyObject }
protocol __text_signature__Owner { func getTextSignature() -> String? }
protocol __traceback__Owner { func getTraceback() -> PyObject }
...
protocol argsOwner { func getArgs() -> PyObject }
...
protocol endswithRangedOwner { func endsWith(_ value: PyObject, start: PyObject?, end: PyObject?) -> PyResultOrNot<Bool> }
...
protocol fdelOwner { func getFDel() -> PyObject }
protocol fgetOwner { func getFGet() -> PyObject }
protocol findRangedOwner { func find(_ value: PyObject, start: PyObject?, end: PyObject?) -> PyResult<Int> }
protocol fsetOwner { func getFSet() -> PyObject }
protocol imagOwner { func asImag() -> PyObject }
protocol indexOwner { func index(of element: PyObject) -> PyResult<BigInt> }
protocol indexRangedOwner { func index(of element: PyObject, start: PyObject?, end: PyObject?) -> PyResult<Int> }
...
protocol rfindRangedOwner { func rfind(_ value: PyObject, start: PyObject?, end: PyObject?) -> PyResult<Int> }
protocol rindexRangedOwner { func rindex(_ value: PyObject, start: PyObject?, end: PyObject?) -> PyResult<Int> }
...
protocol startswithRangedOwner { func startsWith(_ value: PyObject, start: PyObject?, end: PyObject?) -> PyResult<Bool> }
