...
internal enum BuiltinStaticMethods {
  ...
  internal static var object: PyType.StaticallyKnownNotOverriddenMethods = {
    let result = PyType.StaticallyKnownNotOverriddenMethods()
    // result.__repr__ = .init(PyObject.repr(zelf:))
    // result.__str__ = .init(PyObject.str(zelf:))
    // result.__hash__ = .init(PyObject.hash(zelf:))
    // result.__eq__ = .init(PyObject.isEqual(zelf:other:))
    // result.__ne__ = .init(PyObject.isNotEqual(zelf:other:))
    // result.__lt__ = .init(PyObject.isLess(zelf:other:))
    // result.__le__ = .init(PyObject.isLessEqual(zelf:other:))
    // result.__gt__ = .init(PyObject.isGreater(zelf:other:))
    // result.__ge__ = .init(PyObject.isGreaterEqual(zelf:other:))
    // result.__getattribute__ = .init(PyObject.getAttribute(zelf:name:))
    // result.__setattr__ = .init(PyObject.setAttribute(zelf:name:value:))
    // result.__delattr__ = .init(PyObject.delAttribute(zelf:name:))
    // result.__dir__ = .init(PyObject.dir(zelf:))
    return result
  }()
  ...
  internal static var bool: PyType.StaticallyKnownNotOverriddenMethods = {
    let result = BuiltinStaticMethods.int.copy()
  ...
  internal static var builtinFunction: PyType.StaticallyKnownNotOverriddenMethods = {
    let result = BuiltinStaticMethods.object.copy()
  ...
  internal static var importError: PyType.StaticallyKnownNotOverriddenMethods = {
    let result = BuiltinStaticMethods.exception.copy()
  ...
  internal static var keyError: PyType.StaticallyKnownNotOverriddenMethods = {
    let result = BuiltinStaticMethods.lookupError.copy()
