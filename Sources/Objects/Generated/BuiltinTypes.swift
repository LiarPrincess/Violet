...
public final class BuiltinTypes {
  ...
  func fillByteArray() {
    ...
    self.insert(type: type, name: "count", value: PyBuiltinFunction.wrap(name: "count", doc: PyByteArray.countDoc, fn: PyByteArray.count(element:start:end:), castSelf: Self.asByteArray))
    ...
    self.insert(type: type, name: "insert", value: PyBuiltinFunction.wrap(name: "insert", doc: PyByteArray.insertDoc, fn: PyByteArray.insert(index:item:), castSelf: Self.asByteArray))
