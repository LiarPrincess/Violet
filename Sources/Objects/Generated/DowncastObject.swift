...
internal enum Cast {
  ...
  internal static func asPyBuiltinMethod(_ object: PyObject, methodName: String) -> PyResult<PyBuiltinMethod> {
    return cast(object, as: PyBuiltinMethod.self, typeName: "builtinMethod", methodName: methodName)
  }
