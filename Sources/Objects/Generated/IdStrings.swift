...
public struct IdString: CustomStringConvertible {
  ...
  internal struct Collection {
    ...
    internal init(_ py: Py) {
      self.objects = [
        py.intern(string: "__abs__"),
        py.intern(string: "__add__"),
        py.intern(string: "__all__"),
        py.intern(string: "__and__"),
        py.intern(string: "__annotations__"),
        py.intern(string: "__bool__"),
        py.intern(string: "__build_class__"),
        py.intern(string: "__builtins__"),
        py.intern(string: "__call__"),
        py.intern(string: "__class__"),
        py.intern(string: "__class_getitem__"),
        py.intern(string: "__classcell__"),
        py.intern(string: "__complex__"),
        py.intern(string: "__contains__"),
        py.intern(string: "__del__"),
        py.intern(string: "__delattr__"),
        py.intern(string: "__delitem__"),
        py.intern(string: "__dict__"),
        py.intern(string: "__dir__"),
        py.intern(string: "__divmod__"),
        py.intern(string: "__doc__"),
        py.intern(string: "__enter__"),
        py.intern(string: "__eq__"),
        py.intern(string: "__exit__"),
        py.intern(string: "__file__"),
        py.intern(string: "__float__"),
        py.intern(string: "__floordiv__"),
        py.intern(string: "__ge__"),
        py.intern(string: "__get__"),
        py.intern(string: "__getattr__"),
        py.intern(string: "__getattribute__"),
        py.intern(string: "__getitem__"),
        py.intern(string: "__gt__"),
        py.intern(string: "__hash__"),
        py.intern(string: "__iadd__"),
        py.intern(string: "__iand__"),
        py.intern(string: "__idivmod__"),
        py.intern(string: "__ifloordiv__"),
        py.intern(string: "__ilshift__"),
        py.intern(string: "__imatmul__"),
        py.intern(string: "__imod__"),
        py.intern(string: "__import__"),
        py.intern(string: "__imul__"),
        py.intern(string: "__index__"),
        py.intern(string: "__init__"),
        py.intern(string: "__init_subclass__"),
        py.intern(string: "__instancecheck__"),
        py.intern(string: "__int__"),
        py.intern(string: "__invert__"),
        py.intern(string: "__ior__"),
        py.intern(string: "__ipow__"),
        py.intern(string: "__irshift__"),
        py.intern(string: "__isabstractmethod__"),
        py.intern(string: "__isub__"),
        py.intern(string: "__iter__"),
        py.intern(string: "__itruediv__"),
        py.intern(string: "__ixor__"),
        py.intern(string: "__le__"),
        py.intern(string: "__len__"),
        py.intern(string: "__loader__"),
        py.intern(string: "__lshift__"),
        py.intern(string: "__lt__"),
        py.intern(string: "__matmul__"),
        py.intern(string: "__missing__"),
        py.intern(string: "__mod__"),
        py.intern(string: "__module__"),
        py.intern(string: "__mul__"),
        py.intern(string: "__name__"),
        py.intern(string: "__ne__"),
        py.intern(string: "__neg__"),
        py.intern(string: "__new__"),
        py.intern(string: "__next__"),
        py.intern(string: "__or__"),
        py.intern(string: "__package__"),
        py.intern(string: "__path__"),
        py.intern(string: "__pos__"),
        py.intern(string: "__pow__"),
        py.intern(string: "__prepare__"),
        py.intern(string: "__qualname__"),
        py.intern(string: "__radd__"),
        py.intern(string: "__rand__"),
        py.intern(string: "__rdivmod__"),
        py.intern(string: "__repr__"),
        py.intern(string: "__reversed__"),
        py.intern(string: "__rfloordiv__"),
        py.intern(string: "__rlshift__"),
        py.intern(string: "__rmatmul__"),
        py.intern(string: "__rmod__"),
        py.intern(string: "__rmul__"),
        py.intern(string: "__ror__"),
        py.intern(string: "__round__"),
        py.intern(string: "__rpow__"),
        py.intern(string: "__rrshift__"),
        py.intern(string: "__rshift__"),
        py.intern(string: "__rsub__"),
        py.intern(string: "__rtruediv__"),
        py.intern(string: "__rxor__"),
        py.intern(string: "__set__"),
        py.intern(string: "__set_name__"),
        py.intern(string: "__setattr__"),
        py.intern(string: "__setitem__"),
        py.intern(string: "__spec__"),
        py.intern(string: "__str__"),
        py.intern(string: "__sub__"),
        py.intern(string: "__subclasscheck__"),
        py.intern(string: "__truediv__"),
        py.intern(string: "__trunc__"),
        py.intern(string: "__warningregistry__"),
        py.intern(string: "__xor__"),
        py.intern(string: "_find_and_load"),
        py.intern(string: "_handle_fromlist"),
        py.intern(string: "builtins"),
        py.intern(string: "encoding"),
        py.intern(string: "keys"),
        py.intern(string: "metaclass"),
        py.intern(string: "mro"),
        py.intern(string: "name"),
        py.intern(string: "object"),
        py.intern(string: "origin")
      ]
    }
  }
}
