...
internal enum BuiltinTypesFill {
  ...
  internal static func complex(_ type: PyType) {
    ...
    dict["__pow__"] = PyBuiltinFunction.wrap(type.context, name: "__pow__", doc: nil, fn: PyComplex.pow(_:), castSelf: Cast.asPyComplex)
    dict["__rpow__"] = PyBuiltinFunction.wrap(type.context, name: "__rpow__", doc: nil, fn: PyComplex.rpow(_:), castSelf: Cast.asPyComplex)
  ...
  internal static func float(_ type: PyType) {
    ...
    dict["__pow__"] = PyBuiltinFunction.wrap(type.context, name: "__pow__", doc: nil, fn: PyFloat.pow(_:), castSelf: Cast.asPyFloat)
    dict["__rpow__"] = PyBuiltinFunction.wrap(type.context, name: "__rpow__", doc: nil, fn: PyFloat.rpow(_:), castSelf: Cast.asPyFloat)
  ...
  internal static func int(_ type: PyType) {
    ...
    dict["__pow__"] = PyBuiltinFunction.wrap(type.context, name: "__pow__", doc: nil, fn: PyInt.pow(_:), castSelf: Cast.asPyInt)
    dict["__rpow__"] = PyBuiltinFunction.wrap(type.context, name: "__rpow__", doc: nil, fn: PyInt.rpow(_:), castSelf: Cast.asPyInt)
