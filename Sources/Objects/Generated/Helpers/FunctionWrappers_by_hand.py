...
def get_hand_written_function_wrappers() -> List[FunctionWrapperByHand]:
    return [
        FunctionWrapperByHand('NewWrapper',  'new',  '(Type, *args, **kwargs) -> PyResult<PyObject>',   'Python `__new__` function.'),
        FunctionWrapperByHand('InitWrapper', 'init', '(Object, *args, **kwargs) -> PyResult<PyObject>', 'Python `__init__` function.'),
        ...
        FunctionWrapperByHand('ArgsKwargsFunctionWrapper',    'argsKwargsFunction',    '(*args, **kwargs) -> PyResult<PyObject>',         'Function with `*args` and `**kwargs`.'),
        FunctionWrapperByHand('ArgsKwargsMethodWrapper',      'argsKwargsMethod',      '(Object, *args, **kwargs) -> PyResult<PyObject>', 'Method with `*args` and `**kwargs`.'),
        FunctionWrapperByHand('ArgsKwargsClassMethodWrapper', 'argsKwargsClassMethod', '(Type, *args, **kwargs) -> PyResult<PyObject>',   'Class method with `*args` and `**kwargs`.')
    ]
