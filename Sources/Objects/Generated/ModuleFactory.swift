...
internal enum ModuleFactory {
  ...
  internal static func createBuiltins(from object: Builtins) -> PyModule {
    ...
    dict["bytes_iterator"] = object.type_bytes_iterator
    dict["callable_iterator"] = object.type_callable_iterator
    dict["code"] = object.type_code
    dict["complex"] = object.type_complex
    dict["dict"] = object.type_dict
    dict["dict_itemiterator"] = object.type_dict_itemiterator
    dict["dict_items"] = object.type_dict_items
    dict["dict_keyiterator"] = object.type_dict_keyiterator
    dict["dict_keys"] = object.type_dict_keys
    dict["dict_valueiterator"] = object.type_dict_valueiterator
    dict["dict_values"] = object.type_dict_values
    dict["ellipsis"] = object.type_ellipsis
    ...
    dict["function"] = object.type_function
    dict["int"] = object.type_int
    dict["iterator"] = object.type_iterator
    dict["list"] = object.type_list
    dict["list_iterator"] = object.type_list_iterator
    dict["list_reverseiterator"] = object.type_list_reverseiterator
    dict["map"] = object.type_map
    dict["method"] = object.type_method
    dict["module"] = object.type_module
    dict["SimpleNamespace"] = object.type_simpleNamespace
    dict["None"] = object.type_none
    dict["NotImplemented"] = object.type_notImplemented
    dict["property"] = object.type_property
    dict["range"] = object.type_range
    dict["range_iterator"] = object.type_range_iterator
    dict["reversed"] = object.type_reversed
    dict["set"] = object.type_set
    dict["set_iterator"] = object.type_set_iterator
    dict["slice"] = object.type_slice
    dict["str"] = object.type_str
    dict["str_iterator"] = object.type_str_iterator
    dict["TextFile"] = object.type_textFile
    dict["tuple"] = object.type_tuple
    dict["tuple_iterator"] = object.type_tuple_iterator
