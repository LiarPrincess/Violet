...
internal enum ModuleFactory {
  ...
  internal static func createUnderscoreImp(from object: UnderscoreImp) -> PyModule {
    ...
    insert(module: module, name: "create_dynamic", value: PyBuiltinFunction.wrap(name: "create_dynamic", doc: nil, fn: object.createDynamic, module: module))
    insert(module: module, name: "exec_dynamic", value: PyBuiltinFunction.wrap(name: "exec_dynamic", doc: nil, fn: object.execDynamic, module: module))
