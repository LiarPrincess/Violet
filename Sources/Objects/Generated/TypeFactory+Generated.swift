...
extension TypeFactory {
  ...
  internal static func list(_ context: PyContext, type: PyType, base: PyType) -> PyType {
    ...
    result._attributes["extend"] = wrapMethod(context, name: "extend", doc: nil, func: PyList.extend(_:), castSelf: selfAsPyList)
    ...
    result._attributes["__iadd__"] = wrapMethod(context, name: "__iadd__", doc: nil, func: PyList.addInPlace(_:), castSelf: selfAsPyList)
