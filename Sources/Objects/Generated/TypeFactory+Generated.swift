...
extension TypeFactory {
  ...
  internal static func list(_ context: PyContext, type: PyType, base: PyType) -> PyType {
    ...
    dict["index"] = wrapMethod(context, name: "index", doc: nil, fn: PyList.index(of:), castSelf: Cast.asPyList)
  ...
  internal static func tuple(_ context: PyContext, type: PyType, base: PyType) -> PyType {
    ...
    dict["index"] = wrapMethod(context, name: "index", doc: nil, fn: PyTuple.index(of:), castSelf: Cast.asPyTuple)
