...
extension TypeFactory {
  ...
  internal static func list(_ context: PyContext, type: PyType, base: PyType) -> PyType {
    ...
    result._attributes["__imul__"] = wrapMethod(context, name: "__imul__", doc: nil, func: PyList.imul(_:), castSelf: selfAsPyList)
    return result
  }
  ...
  internal static func slice(_ context: PyContext, type: PyType, base: PyType) -> PyType {
    ...
    result._attributes["indices"] = wrapMethod(context, name: "indices", doc: nil, func: PySlice.indicesInSequence(length:), castSelf: selfAsPySlice)
    return result
  }
