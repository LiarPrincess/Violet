...
internal enum FillTypes {
  ...
  internal static func dict(_ type: PyType) {
    ...
    insert(type: type, name: "get", value: PyBuiltinFunction.wrap(name: "get", doc: nil, fn: PyDict.get(args:kwargs:), castSelf: Cast.asPyDict))
    insert(type: type, name: "__iter__", value: PyBuiltinFunction.wrap(name: "__iter__", doc: nil, fn: PyDict.iter, castSelf: Cast.asPyDict))
    insert(type: type, name: "setdefault", value: PyBuiltinFunction.wrap(name: "setdefault", doc: nil, fn: PyDict.setDefault(_:default:), castSelf: Cast.asPyDict))
