...
builtins_config = Config(
  'site-builtins.html', # html_file
  'result-builtins.swift', # output_file
...
sys_config = Config(
  'site-sys.html', # html_file
  'result-sys.swift', # output_file
  'https://docs.python.org/3.7/library/sys.html', # type_url_prefix
  'https://docs.python.org/3.7/library/sys.html', # property_url_prefix
  'https://docs.python.org/3.7/library/sys.html', # function_url_prefix
  -1, # expected_count
)
